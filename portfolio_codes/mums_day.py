...
class Brief:
    ...
    def draw(self, not_yet_step2):
        ...
        if (not self.opened) or not_yet_step2:
            ...
            aff_txt("Maminka", 310, screen_height//2+50, taille=44)
    ...
    def read(self):
        ...
        aff_txt("Pro muji maminku :", 200, 300, taille=40)

        aff_txt("Preju nejkrasnejsi", 195, 400, taille=40)

        aff_txt("Svatek matek !", 185, 500, taille=50)
...
class Heart(Particule):
    ...
    def update(self):
        ...
        Heart.stear_of_screen(self)

        Particule.apply_vect(self)

        Heart.draw(self)

    def stear_of_screen(self):
...
class Flower(Particule):
    ...
    def update(self):
        ...
        Flower.stear_of_screen(self)

        Flower.apply_vect(self, self.vitesse)
    ...
    while play:
        ...
        if step == 4:
            ...
            if flower_append and (random.randint(0, 30) == 0):
                ...
                flower_babes += [Flower(screen_center[0]+random.randint(-100, 100)/100, screen_center[1]+random.randint(-100, 100)/100, random.randint(10, 20)) for x in range(5)]
        ...
        if step == 5:
            ...
            if not compteur < 0:
                ...
                aff_txt("Pusu !!", screen_width//2-50, screen_height//2-30, RED)
